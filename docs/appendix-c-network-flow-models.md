...
1.  We first spatially disaggregate the GDP/day (henceforth referred to
    as GDP) estimates from the electricity sector (Section E 401 from
    Table D-1) to the demand nodes, by assuming that this spatial
    distribution of GDP is proportional to the population served by each
    demand node. This gives us the directly generated electricity sector
    GDP at the demand node level.
...
3.  We assume that two other infrastructure sectors are also dependent
    ...
    <li> We assume that these telecom masts serve the whole
        ...
        telecoms sector (I 640 from Table D-1) we estimate that
...
1.  We intersected the WSZ areas with the population areas of Jamaica to
    ...
    potable water supply sector (Section E 410, see Table D-1) was
...
industries as per the JIC 2005 system (see Table 3‑5 and Table D-1). We
