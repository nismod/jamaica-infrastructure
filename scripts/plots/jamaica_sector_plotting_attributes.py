...
def jamaica_sector_attributes():
    sector_attributes = [
        ...
        },
        {
            ...
            "area_categories": None,
            "edge_categories_colors": None,
            "node_categories_colors": ["#bfd3e6", "#4d004b", "#88419d", "#ef3b2c"],
            "area_categories_colors": None,
            "edge_categories_labels": None,
            "node_categories_labels": [
                "Sump",
...
def jamaica_port_nodes():
    ...
    ports = gpd.GeoDataFrame(
        ports, geometry="geometry", crs=f"EPSG:{JAMAICA_GRID_EPSG}"
    )
