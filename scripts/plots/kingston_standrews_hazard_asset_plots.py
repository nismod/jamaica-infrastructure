    ...
    for sector in sector_attributes:
        ...
        if sector["sector_label"] in ["Roads"]:
            ...
            if len(edges) > 0:
                ...
                legend_handles.append(mpatches.Patch(color=color, label="ROADS"))
            if len(nodes) > 0:
                ax = plot_point_assets(ax, JAMAICA_GRID_EPSG, nodes, color, 10, "o", 11)
                legend_handles.append(
                    plt.plot(
                        [], [], marker="o", ms=10, ls="", color=color, label="BRIDGES"
                    )[0]
                )
            ...
            plt.title(
                f"{sector['sector_label']} 1 in 100 year River Flooding exposure",
                fontsize=10,
            )
            save_fig(
                os.path.join(
                    figures_data_path,
                    f"kst_{sector['sector_label'].replace(' ','_').lower()}_network_river_flood_exposure.png",
                )
            )
            ...
            cbar.ax.set_xlabel("Flood depth (m)", fontsize=7, color="black")
            plt.title(
                f"{sector['sector_label']} 1 in 100 year Coastal Flooding exposure",
                fontsize=10,
            )
            save_fig(
                os.path.join(
            ...
            cbar.ax.set_xlabel("Flood depth (m)", fontsize=7, color="black")
            plt.title(
                f"{sector['sector_label']} traffic counts within 1 in 100 year Coastal Flooding exposure",
                fontsize=10,
            )
            save_fig(
                os.path.join(
            ...
            cbar.ax.set_xlabel("Flood depth (m)", fontsize=7, color="black")
            plt.title(
                f"{sector['sector_label']} traffic counts within 1 in 100 year River Flooding exposure",
                fontsize=10,
            )
            save_fig(
                os.path.join(
        ...
        if sector["sector_label"] in ["Energy"]:
            ...
            plt.title(
                f"{sector['sector_label']} 1 in 100 year Tropical Cyclone exposure",
                fontsize=10,
            )
            save_fig(
                os.path.join(
                    figures_data_path,
                    f"kst_{sector['sector_label'].replace(' ','_').lower()}_network_tc_exposure.png",
                )
            )
