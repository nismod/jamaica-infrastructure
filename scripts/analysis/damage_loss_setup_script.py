...
def main(config, network_csv, hazard_csv):
    ...
    damage_results_folder = os.path.join(
        results_path, "direct_damages")
    summary_folder = os.path.join(
        results_path, "direct_damages_summary")
    timeseries_results_folder = os.path.join(
        results_path, "loss_damage_timeseries")
    discounted_results_folder = os.path.join(
        results_path, "loss_damage_npvs")

    flood_protection_column = "None"

    parameter_combinations_file = os.path.join(processed_data_path, "parameter_combinations.txt")
