    ...
    for param in param_values.itertuples():
        ...
        for asset_info in asset_data_details.itertuples():
            ...
            if len(hazard_damages) > 0:
                ...
                hazard_damages.to_parquet(os.path.join(asset_damages_results,
                            f"{asset_info.asset_gpkg}_{asset_info.asset_layer}_direct_damages_parameter_set_{set_count}.parquet"),index=False)
