...
def main(config):
    ...
    nomangrove = pd.read_parquet(os.path.join(direct_damages_results,"airport_polygon_areas",
    ...
    nomangrove[["node_id","exposure"] + coastal_columns].to_csv(os.path.join(direct_damages_results,"airport_polygon_areas",
    ...
    mangrove = pd.read_parquet(os.path.join(direct_damages_results,"airport_polygon_areas",
        "airport_polygon_areas_direct_damages_parameter_set_0.parquet"))
    print (mangrove)
    mangrove[["node_id","exposure"] + coastal_columns].to_csv(os.path.join(direct_damages_results,"airport_polygon_areas",
        "airport_polygon_areas_direct_damages_parameter_set_0.csv"))
