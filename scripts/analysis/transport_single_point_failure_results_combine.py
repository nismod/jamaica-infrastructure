...
def main(config):
    ...
    ports.to_csv(
        os.path.join(results_dir, "single_point_failure_ports_economic_losses.csv"),
        index=False,
    )
    ...
    rail_losses.to_csv(
        os.path.join(
            results_dir, "single_point_failure_rail_stations_economic_losses.csv"
        ),
        index=False,
    )
    ...
    airports[["node_id", "economic_loss", "loss_unit"]].to_csv(
        os.path.join(results_dir, "single_point_failure_airports_economic_losses.csv"),
        index=False,
    )
