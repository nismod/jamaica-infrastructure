...
potable_assets = potable_assets.groupby(['node_id','node_type','X','Y'])['asset_connected_pop_2020'].sum().to_frame().reset_index()
...
potable_facilities_NWC_pop = potable_facilities_NWC.merge(potable_assets[['node_id','node_type','X','Y','asset_connected_pop_2020']], on='node_id', how='left').drop_duplicates()
...
pipelines_NWC = gpd.read_file('/soge-home/projects/mistral/jamaica-ccri/processed_data/networks/water/potable/raw/pipelines_network_NWC.shp')
...
potable_pipelines_NWC_economic_m[['edge_id','osm_id','A_GDP', 'B_GDP', 'C_GDP', 'D_GDP', 'E_GDP', 'F_GDP', 'G_GDP', 'H_GDP','I_GDP', 'J_GDP', 'K_GDP', 'L_GDP', 'M_GDP', 'N_GDP', 'O_GDP',
       'total_GDP', 'GDP_unit']].to_csv('/soge-home/projects/mistral/jamaica-ccri/processed_data/networks_economic_activity/potable_pipelines_buildings_economic_activity_mapping_070322.csv') # W_GDP
