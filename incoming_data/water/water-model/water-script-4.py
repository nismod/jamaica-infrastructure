...
print(potable_assets.groupby('WSZONEID')['asset_connected_pop_2020'].max().to_frame().reset_index()['asset_connected_pop_2020'].sum())
...
potable_facilities_NWC = gpd.read_file('../../../processed_data/networks/water/ss/potable_facilities_NWC.gpkg')[['OBJECTID', 'LOCATION_x', 'PARISH', 'asset_type', 'Capacity',
       ...
       'comment', 'capacity (mgd) from supplement', 'capacity_inferred', 'cost_unit', 'min_damage_cost',
       'max_damage_cost', 'node_id', 'geometry']]
#potable_facilities_NWC = potable_facilities_NWC.drop(['asset_pop_new_2020'], axis=1)
potable_facilities_NWC = potable_facilities_NWC.drop_duplicates(subset='node_id')
print(potable_facilities_NWC.columns)

potable_facilities_NWC_pop = potable_facilities_NWC.merge(potable_assets_gb[['node_id','node_type','X','Y','asset_connected_pop_2020']], on='node_id', how='left').drop_duplicates()
# check = potable_facilities_NWC_pop.groupby('node_id')['asset_connected_pop_2020'].count().to_frame().reset_index()
# check_1 = check[check['asset_connected_pop_2020']>1]
# print(check_1)
# print(oliv)
# #'WSZONEID','system_connected_pop_2010',
# # groupby sum, connect to neode_id
# print(potable_facilities_NWC.columns)
# print(potable_facilities_NWC_pop.groupby('WSZONEID')['asset_connected_pop_2020'].max().to_frame().reset_index())
# print(oliv)
# check = potable_facilities_NWC_pop.groupby('node_id')['WSZONEID'].count().to_frame().reset_index()
# check_1 = check[check['asset_connected_pop_2020']>1]
# check_wsz = potable_facilities_NWC_pop[potable_facilities_NWC_pop['node_id'].isin(check_1['node_id'].to_list())].groupby('node_id')['WSZONEID'].apply(list).to_frame().reset_index()
# print(check[check['WSZONEID']>1])
# print(check_wsz['WSZONEID']>1)

# potable_facilities_NWC_pop = potable_facilities_NWC_pop.merge(potable_assets[['node_id','node_type','X','Y','WSZONEID','system_connected_pop_2010']], on='node_id', how='left').drop_duplicates()
# potable_facilities_NWC_pop = potable_facilities_NWC.merge(potable_facilities_NWC_pop, on='node_id', how='left').drop_duplicates()
# check = potable_facilities_NWC_pop.groupby('node_id')['WSZONEID'].count().to_frame().reset_index()
# check_1 = check[check['asset_connected_pop_2020']>1]
# print(check_1)
# print(oliv)
...
potable_assets['W_GDP'] = 17648*(1e6/365)*0.8 * (potable_assets['asset_connected_pop_2010']/potable_assets['system_connected_pop_2010'])*(potable_assets['system_connected_pop_2010']/potable_assets.groupby('WSZONEID')['asset_connected_pop_2020'].max().to_frame().reset_index()['asset_connected_pop_2020'].sum())

potable_facilities_NWC_economic = potable_assets[(potable_assets['node_type'].isin(['source','junction']))&(potable_assets['asset_connected_pop_2020']>0)]
potable_facilities_NWC_economic_m = potable_facilities_NWC_economic[['node_id','W_GDP','WSZONEID']].merge(GVA_per_sector_per_parish[['osm_id','A_GDP', 'B_GDP', 'C_GDP', 'D_GDP', 'E_GDP', 'F_GDP', 'G_GDP', 'H_GDP',
...
potable_facilities_NWC_economic_m = potable_facilities_NWC_economic_m[['node_id','osm_id','A_GDP', 'B_GDP', 'C_GDP', 'D_GDP', 'E_GDP', 'F_GDP', 'G_GDP', 'H_GDP',
       'I_GDP', 'J_GDP', 'K_GDP', 'L_GDP', 'M_GDP', 'N_GDP', 'O_GDP',
       'GDP_unit','W_GDP','WSZONEID']]
potable_facilities_NWC_economic_m_gb = potable_facilities_NWC_economic_m.groupby(['node_id'])['W_GDP'].sum().to_frame().reset_index()
potable_facilities_NWC_economic_m_gb['A_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['A_GDP'].sum().to_frame().reset_index()['A_GDP']
potable_facilities_NWC_economic_m_gb['B_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['B_GDP'].sum().to_frame().reset_index()['B_GDP']
potable_facilities_NWC_economic_m_gb['C_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['C_GDP'].sum().to_frame().reset_index()['C_GDP']
potable_facilities_NWC_economic_m_gb['D_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['D_GDP'].sum().to_frame().reset_index()['D_GDP']
potable_facilities_NWC_economic_m_gb['E_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['E_GDP'].sum().to_frame().reset_index()['E_GDP']
potable_facilities_NWC_economic_m_gb['F_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['F_GDP'].sum().to_frame().reset_index()['F_GDP']
potable_facilities_NWC_economic_m_gb['G_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['G_GDP'].sum().to_frame().reset_index()['G_GDP']
potable_facilities_NWC_economic_m_gb['H_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['H_GDP'].sum().to_frame().reset_index()['H_GDP']
potable_facilities_NWC_economic_m_gb['I_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['I_GDP'].sum().to_frame().reset_index()['I_GDP']
potable_facilities_NWC_economic_m_gb['J_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['J_GDP'].sum().to_frame().reset_index()['J_GDP']
potable_facilities_NWC_economic_m_gb['K_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['K_GDP'].sum().to_frame().reset_index()['K_GDP']
potable_facilities_NWC_economic_m_gb['L_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['L_GDP'].sum().to_frame().reset_index()['L_GDP']
potable_facilities_NWC_economic_m_gb['M_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['M_GDP'].sum().to_frame().reset_index()['M_GDP']
potable_facilities_NWC_economic_m_gb['N_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['N_GDP'].sum().to_frame().reset_index()['N_GDP']
potable_facilities_NWC_economic_m_gb['O_GDP'] = potable_facilities_NWC_economic_m.groupby(['node_id'])['O_GDP'].sum().to_frame().reset_index()['O_GDP']
	   
potable_facilities_NWC_economic_m_gb.to_csv('potable_facilities_buildings_economic_activity_mapping_070322.csv') # W_GDP
potable_facilities_NWC_economic_m = pd.read_csv('potable_facilities_buildings_economic_activity_mapping_070322.csv')
print(potable_facilities_NWC_economic_m.columns)
potable_facilities_NWC_economic_m_2 = potable_assets[['node_id','W_GDP','WSZONEID']].merge(GVA_per_sector_per_parish[['osm_id','A_GDP', 'B_GDP', 'C_GDP', 'D_GDP', 'E_GDP', 'F_GDP', 'G_GDP', 'H_GDP',
       'I_GDP', 'J_GDP', 'K_GDP', 'L_GDP', 'M_GDP', 'N_GDP', 'O_GDP',
       'total_GDP', 'GDP_unit','WSZONEID']], on='WSZONEID', how='left')
potable_facilities_NWC_economic_m_2_gb = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['W_GDP'].sum().to_frame().reset_index()
potable_facilities_NWC_economic_m_2_gb['A_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['A_GDP'].sum().to_frame().reset_index()['A_GDP']
potable_facilities_NWC_economic_m_2_gb['B_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['B_GDP'].sum().to_frame().reset_index()['B_GDP']
potable_facilities_NWC_economic_m_2_gb['C_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['C_GDP'].sum().to_frame().reset_index()['C_GDP']
potable_facilities_NWC_economic_m_2_gb['D_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['D_GDP'].sum().to_frame().reset_index()['D_GDP']
potable_facilities_NWC_economic_m_2_gb['E_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['E_GDP'].sum().to_frame().reset_index()['E_GDP']
potable_facilities_NWC_economic_m_2_gb['F_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['F_GDP'].sum().to_frame().reset_index()['F_GDP']
potable_facilities_NWC_economic_m_2_gb['G_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['G_GDP'].sum().to_frame().reset_index()['G_GDP']
potable_facilities_NWC_economic_m_2_gb['H_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['H_GDP'].sum().to_frame().reset_index()['H_GDP']
potable_facilities_NWC_economic_m_2_gb['I_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['I_GDP'].sum().to_frame().reset_index()['I_GDP']
potable_facilities_NWC_economic_m_2_gb['J_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['J_GDP'].sum().to_frame().reset_index()['J_GDP']
potable_facilities_NWC_economic_m_2_gb['K_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['K_GDP'].sum().to_frame().reset_index()['K_GDP']
potable_facilities_NWC_economic_m_2_gb['L_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['L_GDP'].sum().to_frame().reset_index()['L_GDP']
potable_facilities_NWC_economic_m_2_gb['M_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['M_GDP'].sum().to_frame().reset_index()['M_GDP']
potable_facilities_NWC_economic_m_2_gb['N_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['N_GDP'].sum().to_frame().reset_index()['N_GDP']
potable_facilities_NWC_economic_m_2_gb['O_GDP'] = potable_facilities_NWC_economic_m_2.groupby(['node_id'])['O_GDP'].sum().to_frame().reset_index()['O_GDP']
potable_facilities_NWC_economic_m_2_gb.to_csv('potable_facilities_dependent_economic_activity_070322.csv')
...
potable_facilities_NWC_pop.to_file('potable_facilities_NWC_pop_update_070322.gpkg', driver='GPKG', layer='node')
...
potable_pipelines_NWC_economic_m = pd.merge(pipelines_NWC_pop[['edge_id','node_id']].head(50), potable_facilities_NWC_economic_m[['node_id','A_GDP', 'B_GDP', 'C_GDP', 'D_GDP', 'E_GDP', 'F_GDP', 'G_GDP', 'H_GDP',
       'I_GDP', 'J_GDP', 'K_GDP', 'L_GDP', 'M_GDP', 'N_GDP', 'O_GDP',
       'W_GDP']], on='node_id', how='left')
